...
//	cout << "here = " << arr.size() << endl;
	...
	while(tc--)
	{
		ll a,b;
		sfl2(a,b);
		ll n1 = lower_bound(arr.begin(),arr.end(),a) - arr.begin();
		ll n2 = upper_bound(arr.begin(),arr.end(),b) - arr.begin();
		ll len = n2-n1;
		if(len<0) len = 0;
